...
**Podemos graficar $D(n)$, E1 y E2 para la secuencia "b1130"**. Procesada con una sensibilidad de 0.7 se puede observar un valor de $D(n)$ sobre el umbral, lo que nos indica que podría estar allí el TSS.  
